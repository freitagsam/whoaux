...
export default function NewBracketPage() {
  ...
  const steps: Step[] = ["mode", ...(mode === "artist" || mode === "album" ? ["filter" as Step] : []), "seeding", "size"];
      ...
      <main className="pt-24 pb-20 px-6 max-w-2xl mx-auto">
        ...
        {step === "mode" && (
          <div className="animate-scale-in space-y-3">
            ...
            {[
              {
                id: "top" as BracketMode,
                icon: TrendingUp,
                label: "My Top Songs",
                desc: `Your ${data.topSongs.length} most-played tracks`,
                color: "var(--green)",
              },
              {
                id: "liked" as BracketMode,
                icon: Heart,
                label: "Liked Songs",
                desc: `${data.likedSongs.length} songs from your library`,
                color: "#ff6b8a",
              },
              {
                id: "artist" as BracketMode,
                icon: User,
                label: "Artist Discography",
                desc: `All songs from a specific artist`,
                color: "var(--cyan)",
              },
              {
                id: "album" as BracketMode,
                icon: Disc3,
                label: "Album",
                desc: "Every track from one album",
                color: "#a855f7",
              },
        ...
        {step === "filter" && (
          <div className="animate-scale-in">
            <h2 className="text-2xl font-semibold mb-5">
              {mode === "artist" ? "Choose an Artist" : "Choose an Album"}
            </h2>
            ...
            <div className="relative mb-4">
              ...
              <input
                type="text"
                placeholder={mode === "artist" ? "Search artists..." : "Search albums..."}
                value={search}
